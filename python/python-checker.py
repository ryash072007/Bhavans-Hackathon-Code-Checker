...
class PythonChecker:
    ...
    def is_correct_output(self, team_code, program_code: str, question_index: int):
...
if __name__ == "__main__":
    ...
    print(PyChecker.is_correct_output(TEAM_CODE_MOCK, 'print("Hello World!")', 1))
    print(PyChecker.is_correct_output(TEAM_CODE_MOCK, 'print(str(4152))', 2))
    print(PyChecker.is_correct_output(TEAM_CODE_MOCK, 'print("Confirming Output")', 3))